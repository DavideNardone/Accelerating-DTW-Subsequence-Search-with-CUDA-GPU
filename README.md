...
- **-k**: In the **CLASSIFICATION** task is possible to perform *k-fold cross validation* by specifying the number of folders (e.g., -k 10 0). An additional flag(0-1) is used for performing the shuffling among the folders generated. <br>
